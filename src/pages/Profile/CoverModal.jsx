...
const CoverModal = ({ openCoverModal, handleCloseCoverModal, selectedCoverImage, handleCoverConfirmation }) => {
   ...
   return (
      <Modal open={openCoverModal} onClose={handleCloseCoverModal}>
         <Box sx={{ width: 'auto', height: 'auto', position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'background.paper', boxShadow: 24, p: 4, borderRadius: '8px' }}>
            <div className="flex-row">
               <img src={selectedCoverImage} alt="Selected Cover" style={{ width: '50%', height: '50%', maxWidth: '50%', maxHeight: '50%' }} className="rounded-xl" />
            ...
            <div className='flex w-full justify-end'>
               <Button onClick={() => handleCoverConfirmation(caption)} variant="contained" color="primary" >Confirm Cover</Button>
            </div>
         </Box>
      </Modal>
   );
